...
public class SpringRestClient {
	 ...
	 private static final String GET_EMPLOYEES_ENDPOINT_URL = "http://localhost:8080/api/v1/employees";
	    ...
	    private void getEmployeeById() {
	        ...
	        Employees result = restTemplate.getForObject(GET_EMPLOYEE_ENDPOINT_URL, Employees.class, params);
	    ...
	    private void createEmployee() {
	        ...
	        Employees newEmployee = new Employees("admin", "admin", "admin@gmail.com");

	        RestTemplate restTemplate = new RestTemplate();
	        Employees result = restTemplate.postForObject(CREATE_EMPLOYEE_ENDPOINT_URL, newEmployee, Employees.class);
	    ...
	    private void updateEmployee() {
	        Map < String, String > params = new HashMap < String, String > ();
	        params.put("id", "1");
	        Employees updatedEmployee = new Employees("admin123", "admin123", "admin123@gmail.com");
	        RestTemplate restTemplate = new RestTemplate();
